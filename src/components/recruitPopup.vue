<template>
    <!-- 招聘弹出窗 -->
    <div class="recruitPopup" style="display: none">
        <div class="recruitPopupBox">
            <!-- 关闭键 -->
            <img class="recruitPopupDel" src="../assets/images/icon/关闭  X@2x.png" alt="">
            <div class="recruitPopupText">
                ...
                <button><a href="javascript:;">投递简历</a></button>
                <p class="recruitHint">请上传pdf、word、html格式的文件，大小不超过5M</p>
            </div>
            <!-- 添加内容 2018.7.24 -->
            <!-- 投递简历 -->
            <div class="submitResume" style="display: block">
